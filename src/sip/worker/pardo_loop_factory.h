...
public:
	enum Loop_t {
		...
		Fragment_ij_ao_vo_PardoLoopManager,
		Fragment_ij_av_oo_PardoLoopManager,
		Fragment_ij_av_vo_PardoLoopManager,
		Fragment_ij_ao_oo_PardoLoopManager,
		Fragment_ij_oo_ao_PardoLoopManager,
		Fragment_ij_aoo_o_PardoLoopManager,
		Fragment_ij_vo_vo_PardoLoopManager,
		Fragment_i_vo__PardoLoopManager,
		Fragment_i_vv__PardoLoopManager,
		Fragment_i_oo__PardoLoopManager,
		Fragment_i_vovo__PardoLoopManager,
		...
		Fragment_NR1ij_oo_vo_PardoLoopManager,
		Fragment_NR1ij_vv_vo_PardoLoopManager,
	};
