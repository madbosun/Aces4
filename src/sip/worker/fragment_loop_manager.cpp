...
/*
 ...
 see comment above for fragment_special_where_clause syntax
 */
bool Fragment_i_vv__PardoLoopManager::where_clause(int index) {
	bool where_;
	int ifrag = 0;
	int jfrag = 1;
	int ao = 1;
...
bool Fragment_i_vv__PardoLoopManager::do_update() {
	if (to_exit_)
		return false;
	bool more_iters;
	bool where_clauses_value;
...
Fragment_i_vv__PardoLoopManager::Fragment_i_vv__PardoLoopManager(
		int num_indices, const int (&index_id)[MAX_RANK],
		DataManager & data_manager, const SipTables & sip_tables,
		SIPMPIAttr & sip_mpi_attr, int num_where_clauses,
		Interpreter* interpreter, long& iteration) :
...
/*
 ...
 see comment above for fragment_special_where_clause syntax
 */
bool Fragment_i_oo__PardoLoopManager::where_clause(int index) {
	bool where_;
	int ifrag = 0;
	int jfrag = 1;
	int ao = 1;
...
bool Fragment_i_oo__PardoLoopManager::do_update() {
	if (to_exit_)
		return false;
	bool more_iters;
	bool where_clauses_value;
...
Fragment_i_oo__PardoLoopManager::Fragment_i_oo__PardoLoopManager(
		int num_indices, const int (&index_id)[MAX_RANK],
		DataManager & data_manager, const SipTables & sip_tables,
		SIPMPIAttr & sip_mpi_attr, int num_where_clauses,
		Interpreter* interpreter, long& iteration) :
